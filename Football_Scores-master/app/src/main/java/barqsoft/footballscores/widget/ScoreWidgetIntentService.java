...
/**
 *
 * Created by fabianrodriguez on 1/24/16.
 */
@TargetApi(Build.VERSION_CODES.HONEYCOMB)
public class ScoreWidgetIntentService extends RemoteViewsService {
    public final String LOG_TAG = ScoreWidgetIntentService.class.getSimpleName();
